...
class Gui:
    ...
    def show_gui(self):
        ...
        layout = [
            [
                sg.Checkbox(
                    "History", default=True, enable_events=True, k="history_check"
                )
            ],
            [
                sg.Multiline(
                    default_text=self.state["history"], size=(None, 5), k="history_text"
                )
            ],
            [sg.HorizontalSeparator()],
            [
                sg.Checkbox(
                    "Examination", default=True, enable_events=True, k="exam_check"
                )
            ],
            [
                sg.Multiline(
                    default_text=self.state["exam"], size=(None, 4), k="exam_text"
                )
            ],
            [sg.HorizontalSeparator()],
            [
                sg.Checkbox(
                    "Impression", default=True, enable_events=True, k="imp_check"
                )
            ],
            [
                sg.Multiline(
                    default_text=self.state["imp"], size=(None, 3), k="imp_text"
                )
            ],
            [sg.HorizontalSeparator()],
            ...
            [
                sg.Multiline(
                    default_text=self.state["plan"], size=(None, 5), k="plan_text"
                )
            ],
            [sg.HorizontalSeparator()],
            [sg.Button("Ok")],
